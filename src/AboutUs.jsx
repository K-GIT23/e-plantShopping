  ...
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-content">
        ...
        enchanced focus - Oh we did! That is why we have a variety of plants available for your increased enjoyment of life. 
        </p>
        <p className="about-us-content">
        ...
        <p className="about-us-content">
        Whether you choose the beauty of a floral aromatic selection, plants you can care for, 
        edibles, or other types we have available, plants can bring new life to your day and your 
        outlook. 
        </p>
        <p className="about-us-content">
        Feel free to explore our collections, ask questions, and let us help you find the
        perfect plant for your home or office. Our team of experts is dedicated to ensuring 
